    ...
    <section id="heroProjects">
      ...
      >
        ...
        <div className="parallax-layer pointer-events-auto fixed top-0 left-0 w-full h-full flex flex-col items-center justify-start z-7">
          ...
          <h2 className="xl:ml-200 sm:ml-100 ml-70 home-title mt-100 sm:mt-150 text-background text-5xl lg:text-6xl xl:text-7xl  border-4 border-transparent hover:border-background/80 transition-all duration-1250 rounded-md fade-in pb-1 pt-2 px-2">2024</h2>
