    ...
    <section id="heroProjects">
      ...
      >
        ...
        <div className="parallax-layer pointer-events-auto fixed top-0 left-0 w-full h-[105lvh] flex flex-col items-center justify-start z-7">
          <h2 className="xl:ml-180 md:ml-160 sm:ml-140 ml-80  home-title mt-170 md:mt-180  text-background text-5xl lg:text-6xl xl:text-7xl  border-4 border-transparent hover:border-background/80 transition-all duration-1250 rounded-md fade-in pb-1 pt-2 px-2">2025</h2>
          <h2 className="xl:ml-180 md:ml-160 sm:ml-140 ml-80 home-title mt-120 md:mt-140 xl:mt-200 text-background text-5xl lg:text-6xl xl:text-7xl  border-4 border-transparent hover:border-background/80 transition-all duration-1250 rounded-md fade-in pb-1 pt-2 px-2">2024</h2>
          <h2 className="hidden xl:ml-180 md:ml-160 sm:ml-140 ml-80 home-title mt-80 text-background text-5xl lg:text-6xl xl:text-7xl  border-4 border-transparent hover:border-background/80 transition-all duration-1250 rounded-md fade-in pb-1 pt-2 px-2">2023</h2>        
        </div>
        ...
        <div className="parallax-layer pointer-events-none fixed z-25 w-full left-0 top-0 -mt-0.5 ">
          <div className="w-full h-[105lvh] bg-[url('/Layered/LayeredL4.png')] bg-cover bg-center"></div>
